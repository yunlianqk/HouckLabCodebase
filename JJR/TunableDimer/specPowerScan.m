...
save([dataDirectory 'specPowerScan' num2str(time(1)) num2str(time(2)) num2str(time(3)) num2str(time(4)) num2str(time(5)) num2str(time(6)) '.mat'],...
        'CM','f0','fc','specWaitTime','pnaxSettings','fspec','time','steps',...
        'S21specPowerScanAmp','S21specPowerScanPhase','powerVector',...
        'yoko1','yoko2','yoko3','transWaitTime');
