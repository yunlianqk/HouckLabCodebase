...
% Configure PNAX to default settings
    ...
    fprintf(instr, ['CALCulate1:PARameter:EXTended ', pnax.transtrace2, ', S21']);
    ...
    fprintf(instr, ['CALCulate2:PARameter:EXTended ', pnax.spectrace2, ', S21']);
