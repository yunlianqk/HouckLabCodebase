classdef GateSingleShot < measlib.SingleShot.SingleShot
    ...
    methods
        function self = GateSingleShot()
            self = self@measlib.SingleShot.SingleShot();
    ...
    methods (Access = protected)
        ...
        % Set the waveforms for AWG
            ...
            tMeas = max(size(self.qPulse, 2)*self.qPulse(1,1).totalDuration, 2e-6);
