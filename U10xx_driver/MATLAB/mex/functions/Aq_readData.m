...
% $Id: Aq_readData.m 33903 2009-01-26 16:45:39Z bdonnier $

function [status dataDesc segDescArray dataArray] = Aq_readData(instrumentID, channel, readParAnyOrder)
warning ('Deprecated function. Please use AqD1_readData function')
