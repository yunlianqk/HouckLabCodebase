...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% GetStarted8bitMultiSegment.m : MATLAB demo program for Agilent Acqiris 
%                                Digitizers
%--------------------------------------------------------------------------
...
disp('Agilent Acqiris - GetStarted8bitMultiSegment');
...
AqReadParameters.dataArraySize = (nbrSamplesNom + segmentPad) * (nbrSegmentsNom + 1);
