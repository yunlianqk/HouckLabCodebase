classdef m9703a
    ...
    properties
        samplerate=1.6e9/32;   % Hz units
        samples=100e-6*1.6e9/32;    % samples for a single trace
        averages=1;  % software averages PER SEGMENT; total avg=self.averages*self.segments
        segments=2; % segments>1 => sequence mode in readIandQ
...
%         trigSource='Channel1'; % Trigger source
%         trigLevel=0.5; % Trigger level in volts
%         trigPeriod=145e-6; % Trigger period in seconds
