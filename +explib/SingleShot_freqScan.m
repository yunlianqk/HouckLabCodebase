...
freqVector = linspace(10.1656e9,10.166e9,60);
...
for ind = 1:length(freqVector)
    ...
    figure(213);
    subplot(1,2,1)
    [hAx,hLine1,hLine2]=plotyy(freqVector(1:ind), loopResults.optimalFidelity(1:ind),freqVector(1:ind), loopResults.optimalWindow(1:ind))
...
save(['C:\Data\SingleShot_freqScan' '_' num2str(time(1)) num2str(time(2)) num2str(time(3)) num2str(time(4)) num2str(time(5)) num2str(time(6)) '.mat'],...
        'loopResults', 'awg','card','cardparams','x','freqVector','trials','bins');
