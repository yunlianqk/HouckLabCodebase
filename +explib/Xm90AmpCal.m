classdef Xm90AmpCal< handle
    ...
    properties
        ...
        qubitSigma = 25e-9;
        iGateType = 'Xm90'; % initial gate (currently just use a half power pi pulse... need to rethink how this should be done after calibrations!)
        gateType = 'Xm90'; % repeated gate type 
