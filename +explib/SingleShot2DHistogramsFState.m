classdef SingleShot2DHistogramsFState < handle
    ...
    methods
        function obj=SingleShot2DHistogramsFState(pulseCal,varargin)
...
%             obj.qubit = obj.pulseCal.X180();
            ...
            obj.fPulse = obj.pulseCal.X180();
%             obj.fPulse = obj.pulseCal.X90();
            obj.measurement = obj.pulseCal.measurement();
            obj.measStartTime = obj.pulseCal.startBuffer+obj.fPulse.totalDuration+obj.qubit.totalDuration;
            obj.fPulseTime = obj.measStartTime-obj.pulseCal.measBuffer-obj.fPulse.totalDuration/2;
            obj.qubitPulseTime = obj.fPulseTime-obj.qubit.totalDuration;
...
%             clear iMeasMod qMeasMod
            ...
            %generate f segment
            f = obj.fPulse;
            [iFBaseband qFBaseband] = f.uwWaveforms(t, obj.fPulseTime);
            iFMod=cos(2*pi*obj.w12Freq*t).*iFBaseband;
%             clear rQubitBaseband;
            qFMod=sin(2*pi*obj.w12Freq*t).*qFBaseband;
%             clear rQubitBaseband;
            fWaveform = iQubitMod+qQubitMod+iFMod+qFMod+iMeasMod+qMeasMod;
%             clear iMeasMod qMeasMod
...
%             clear backgroundWaveform;
            ...
            % load Rabi segment
            iqdownload(fWaveform,awg.samplerate,'channelMapping',[1 0; 0 0; 0 0; 0 0],'segmentNumber',rabiId,'keepOpen',1,'run',0,'marker',markerWaveform);
%             clear rabiWaveform;
            % load lo segment
