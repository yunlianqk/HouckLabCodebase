...
%             windowStability = zeros(1,softAverages); % preallocate vector to track approach to stable fidelity
            ...
            for ind = 1:softAverages
                ...
                if ind == 1
                    ...
                    gndIHist = zeros(obj.bins);
                    gndQHist = zeros(obj.bins);
                    gndAHist = zeros(obj.bins);
                    gndPHist = zeros(obj.bins);
                    exIHist = zeros(obj.bins);
                    exQHist = zeros(obj.bins);
                    exAHist = zeros(obj.bins);
                    exPHist = zeros(obj.bins);
                end
