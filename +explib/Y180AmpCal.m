classdef Y180AmpCal< handle
    ...
    properties
        ...
        gateType = 'Y180'; % repeated gate type 
    ...
    methods
        ...
        function obj=initSequences(obj)
            ...
            obj.iGate.dragAmplitude = obj.iGateDragAmplitude;
