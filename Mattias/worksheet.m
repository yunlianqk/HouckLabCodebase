...
load('C:\Users\Administrator\Documents\Data\Mattias\tunableDimer\calibrations\pulseCal.mat')
...
% x = SweepTransmissionFrequencyWithQubitPulse_v2()
...
save([x.experimentName '_' num2str(time(1)) num2str(time(2)) num2str(time(3)) num2str(time(4)) num2str(time(5)) num2str(time(6)) '.mat'],...
