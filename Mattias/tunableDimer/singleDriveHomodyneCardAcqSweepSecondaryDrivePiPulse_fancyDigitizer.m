...
%         measurementPoint.powerSetPoints = [linspace(5, 8, 20)];
        ...
        if qubitDrivePowerVec(ldx)<-20
            measurementPoint.name = ['maxJ_DDDO_driveAt' num2str(measurementPoint.probeFrequency/1e9) '_switchingCompare_qubitDriveOff'];
        else
            measurementPoint.name = ['maxJ_DDDO_driveAt' num2str(measurementPoint.probeFrequency/1e9) '_switchingCompare_qubitDrivePower' num2str(qubitDrivePowerVec(ldx)) 'dBm'];
        end
