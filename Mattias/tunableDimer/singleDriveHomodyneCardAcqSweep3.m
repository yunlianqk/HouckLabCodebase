...
% for ldx = 1:fsteps
% measurementPoint = {};
% measurementPoint.name = ['maxJ_dualDriveSplit_vtraj' num2str(ldx)];
% measurementPoint.voltagePoint = vtraj(:,ldx);
% measurementPoint.powerSetPoints =linspace(-20,-9,30);
...
%          saveFolder = ['Z:\Mattias\Data\tunableDimer\DualDriveCompareBistability_LeftOutput_' runDate '\'];
         saveFolder = ['Z:\Mattias\Data\tunableDimer\singleDriveHomodyne_LeftOutput_' runDate '\'];
