...
% fprintf(tek.instrhandle, 'sour3:wav? ');  fscanf(tek.instrhandle, '%f')

% fprintf(tek.instrhandle, 'sour2:Dig:Voltage:OFFSET?'); fscanf(tek.instrhandle, '%f')
% fprintf(tek.instrhandle, 'sour2:Voltage:OFFSET?'); fscanf(tek.instrhandle, '%f')
% fprintf(tek.instrhandle, 'sour2:Analog:Voltage:OFFSET?'); fscanf(tek.instrhandle, '%f')

% 
% fprintf(tek.instrhandle, 'sour2:Voltage:OFFSET 0.25')
% fprintf(tek.instrhandle, 'sour2:Voltage:OFFSET?'); fscanf(tek.instrhandle, '%f')

fprintf(tek.instrhandle, 'sour2:Voltage:Amplitude 0.505')
fprintf(tek.instrhandle, 'sour2:Voltage:Amplitude?'); fscanf(tek.instrhandle, '%f')
