...
fstart=[0.0 rightQubitMax 0.0];
fstop=[0.0 rightQubitResonance 0.0];fsteps=5;
...
pnax.TrigContinuous;
specWaitTime = 10;
pnax.params.cwpower = -50 + PNAXattenuation;
...
%     saveFolder = 'C:\Users\BFG\Documents\Mattias\tunableDimer\SpecScans_081617\';
    ...
    if ~mod(idx,20)
        save([saveFolder filename '.mat'],...
            ...
            'specFreqVector','transFreqVector','specWaitTime','transWaitTime','vtraj', 'ftraj', 'AllFiles');
    end
