...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% GetStarted16bitSingleSegment.m : MATLAB demo program for Agilent Acqiris 
%                                  Digitizers
%--------------------------------------------------------------------------
...
disp('Agilent Acqiris - GetStarted16bitSingleSegment');
...
AqReadParameters.readMode = 0; % ReadModeSeqW all the segments in one DMA
