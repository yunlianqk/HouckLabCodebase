% Returns the data acqired by the Time Counter as ViInt32 values.
%
% Please refer to the Programmer's Reference Manual for more information.
%

% (c) Copyright 2006, 2007-2009 Agilent Technologies, Inc.
% $Id: AqT3_readDataInt32.m 33903 2009-01-26 16:45:39Z bdonnier $

function [status dataDesc dataArray] = AqT3_readDataInt32(instrumentID, channel, readParAnyOrder)
...
[status dataDesc dataArray] = AqDrvMex('AqT3_readDataInt32', instrumentID, channel, readPar);
