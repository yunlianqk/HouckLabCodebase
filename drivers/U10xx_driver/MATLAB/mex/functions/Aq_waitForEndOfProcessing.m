...
% $Id: Aq_waitForEndOfProcessing.m 33903 2009-01-26 16:45:39Z bdonnier $

function [status ] = Aq_waitForEndOfProcessing(instrumentID, timeOut)
warning ('Deprecated function. Please use AqD1_waitForEndOfProcessing function')
