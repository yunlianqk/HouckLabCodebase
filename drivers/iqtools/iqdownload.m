...
%% establish a connection and download the data
    switch (arbConfig.model)
        ...
        case { 'M8190A' 'M8190A_base' 'M8190A_14bit' 'M8190A_12bit' 'M8190A_DUC_x3' 'M8190A_DUC_x12' 'M8190A_DUC_x24' 'M8190A_DUC_x48' }
            result = iqdownload_M8190A(arbConfig, fs, data, marker1, marker2, segmNum, keepOpen, channelMapping, sequence, run, segmentLength, segmentOffset);
        case { 'M8195A_Rev0' }
        ...
        case { 'M8195A_1ch' 'M8195A_1ch_mrk' 'M8195A_2ch' 'M8195A_2ch_mrk' 'M8195A_4ch' 'M8195A_2ch_256k' 'M8195A_4ch_256k' }
            result = iqdownload_M8195A(arbConfig, fs, data, marker1, marker2, segmNum, keepOpen, channelMapping, sequence, run, segmentLength, segmentOffset);
        case { 'M8196A' }
