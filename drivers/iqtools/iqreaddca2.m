function [yval, fs] = iqreaddca2(arbConfig, chan, ~, duration, avg, maxAmpl, trigFreq)
...
if (trigFreq ~= 0)
    numPts = 65536; % can be larger as well in this case
    if (flex)
