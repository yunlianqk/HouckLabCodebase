...
//
//	6/2016	RD	Updated with new GetAbsPowerLevel and GetDLLVersion functions
//
// ------ ANSI-C Calling Convention --------------------------------------
...
VNX_LMS_API int fnLMS_GetModelName(DEVID deviceID, char *ModelName);
